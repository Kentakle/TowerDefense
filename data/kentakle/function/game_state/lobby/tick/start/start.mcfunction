...
function kentakle:game_state/game/start_setup/spawn_ensure_entities/villager
function kentakle:game_state/game/start_setup/spawn_ensure_entities/armor_stand
# Вы
