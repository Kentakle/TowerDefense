...
#=======================================================================================================================================================================================================================================#
    # Открывает нужную страницу в build_menu
        execute if entity @s[advancements={kentakle:global_trigger/triggers={open_build_menu_defense=true}}] run function kentakle:handler/player/set_viewport/build_menu/defense/get_storage
        execute if entity @s[advancements={kentakle:global_trigger/triggers={open_build_menu_supplies=true}}] run function kentakle:handler/player/set_viewport/build_menu/supplies/get_storage
        execute if entity @s[advancements={kentakle:global_trigger/triggers={open_build_menu_buff=true}}] run function kentakle:handler/player/set_viewport/build_menu/buff/get_storage
